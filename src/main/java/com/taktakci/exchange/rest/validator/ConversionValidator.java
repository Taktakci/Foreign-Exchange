...
public class ConversionValidator {
    ...
    public void validateConversionListParameters(Long transactionId, String transactionDate) {
        ...
        if (transactionId != null && transactionId <= 0) {
            logger.error("transactionId must be a number, transactionId={}", transactionId);
